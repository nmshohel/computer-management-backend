...
router.post(
  ...
  (0, validateRequest_1.default)(pbs_validation_1.PbsValidation.create),
  pbs_controller_1.PbsController.insertIntoDB
);
router.delete(
  '/:pbsCode',
  (0, auth_1.default)(ADMIN, SUPER_ADMIN),
  pbs_controller_1.PbsController.singleDeleteFromDB
);
router.get(
  '/',
  (0, auth_1.default)(
