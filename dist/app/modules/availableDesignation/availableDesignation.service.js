...
const getAllFromDB = (filters, options, pbsCode) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (searchTerm) {
        andConditions.push({
            OR: availableDesignation_constrant_1.availableDesignationSearchableFields.map(field => ({
                [field]: {
                    contains: searchTerm,
                    mode: 'insensitive',
                },
    ...
    const result = yield prisma_1.default.availableDesignation.findMany({
...
const getDataById = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield prisma_1.default.availableDesignation.findUnique({
        where: {
            id: id,
        },
        include: {
...
const updateIntoDB = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield prisma_1.default.availableDesignation.update({
        where: {
            id: id,
        },
        include: {
...
exports.AvailableDesignationService = {
    inertIntoDB,
    getAllFromDB,
    getDataById,
    deleteById,
